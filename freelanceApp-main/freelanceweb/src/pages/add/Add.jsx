        ...
        <div className='container'>
            ...
            <div className='sections'>
                <div className='left'>
                    ...
                    <textarea name='desc' id='' cols='30' rows='16' placeholder='Brief description to introduce your services to customers' onChange={handleChange}></textarea>
                ...
                <div className='right'>
                    ...
                    <input type='number' onChange={handleChange} min="revisionNumber"/>
